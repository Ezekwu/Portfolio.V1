  ...
  return (
    <StyledProjectDesc>
      ...
      <div className="wrapper container">
        ...
        <div className="link">
          <a
            href="https://courageegbude.netlify.app/"
            target="_blank"
            rel="noreferrer"
          >
            Live-site
          ...
          <a
            href="https://coin-trackk.netlify.app/"
            target="_blank"
            rel="noreferrer"
          >
            Repository
        ...
        <div className="div">
          ...
          <p className="padding-0">
            This was a portfilo website for Courage Egbude, a UI/UX designer
        ...
        <div className="div">
          ...
          <p className="padding-0">
            This project was relatively easy for me cause it is pretty straight
            forward. However, i had to approach the project in an orgarnized
            manner, creating reusable components that will be used throughout
            the website so as to make my code clean, readable, and maintainable.
          </p>
        </div>
